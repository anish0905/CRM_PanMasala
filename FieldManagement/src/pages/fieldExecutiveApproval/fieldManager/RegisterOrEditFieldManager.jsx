...
const FEARegistaionForm = ({
  ...
  const feaId = localStorage.getItem("FEA_id");

  const { name } = useParams("fieldExecutive");
      ...
      try {
        ...
        if (response.ok) {
          Swal.fire({
            ...
            text: isEdit
              ? "F E  updated successfully."
              : "F E  registered successfully.",
