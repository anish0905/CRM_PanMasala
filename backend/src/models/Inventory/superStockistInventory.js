...
const SuperstockistInventorySchema = new mongoose.Schema({
  ...
  revisedStockHistory: [
    {
      revisedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'CNFAgent', required: true },
  ...
  dispatchedStockHistory: [
    {
      issuedTo: { type: mongoose.Schema.Types.ObjectId,  ref: 'SuperStockist'|| 'Distributor', required: true },
      issuedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'SuperStockist', required: true },
