...
const CNFInventorySchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: 'CNFAgent', required: true },
  ...
  revisedStockHistory: [
    {
      revisedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'subAdmin', required: true },
  ...
  dispatchedStockHistory: [
    {
      ...
      issuedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'CNF'|| 'SuperStockist', required: true },
...
const CNFInventory = mongoose.model('CNFInventory', CNFInventorySchema);
module.exports = CNFInventory;
