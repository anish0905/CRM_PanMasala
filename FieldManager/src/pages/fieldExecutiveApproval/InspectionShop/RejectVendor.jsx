            ...
            <div className="bg-[#1e40af] text-black rounded-xl p-4 my-8  ">
              ...
              <div className="overflow-x-auto overflow-y-auto">
                <table className="min-w-full text-center">
                  <thead>
                    <tr className="bg-[#93c5fd] text-black sm:text-sm text-center">
                  ...
                  <tbody>
                    {paginatedShops().map((shop) => (
                      <tr
                        key={shop._id}
                        className="bg-gray-200 border-b-2 border-blue-200 text-center"
                      >
                        ...
                        <td>
                          <div className="text-gray-700 mt-4 p-4  text-center">
