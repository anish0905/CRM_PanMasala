...
const SuperstockistRegister = ({
    ...
    try {
      ...
      if (selectedsuperstockist) {
        response = await axios.put(
          `${URI}/api/superstockist/update/${selectedsuperstockist._id}`,
          requestData
        );
  ...
  useEffect(() => {
    if (selectedsuperstockist) {
      setFormData({
        username: selectedsuperstockist.username,
        email: selectedsuperstockist.email,
        address: selectedsuperstockist.address,
        city: selectedsuperstockist.city,
        pinCode: selectedsuperstockist.pinCode,
        state: selectedsuperstockist.state,
        district: selectedsuperstockist.district || "", // Pre-fill district if available
        mobileNo: selectedsuperstockist.mobileNo || "",
      });
    }
  }, [selectedsuperstockist]);
      ...
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-2xl">
        <div className="flex justify-between items-center mb-4">
          <h4 className="text-xl font-bold text-blue-700">
            {selectedsuperstockist ? "Update Delivery Boy" : "Registration"}
          </h4>
          <IoMdClose
            onClick={onClose}
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="mt-4">
            ...
            >
              {selectedsuperstockist ? "Update" : "Register"}
            </button>
          </div>
        </form>
      </div>
