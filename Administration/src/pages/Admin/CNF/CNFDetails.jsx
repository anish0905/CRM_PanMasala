  ...
  const fetchCNFs = async () => {
    try {
      const response =
        ...
        location.pathname === "/manage/CNF/user/Admin" ||
        location.pathname === "/manage/CNF/inventory/Admin"
